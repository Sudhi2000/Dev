...
@Component({
  selector: 'app-chemical-disposal-create',
  templateUrl: './chemical-disposal-create.component.html',
  styleUrls: ['./chemical-disposal-create.component.scss'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS }
  ]
})
export class ChemicalDisposalCreateComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,private generalService: GeneralService,
    ...
    public dialogRef: MatDialogRef<ChemicalDisposalCreateComponent>) {
  }
  ...
  ngOnInit() {
    ...
    this.Form = this.formBuilder.group({
      ...
      chemical: [this.defaults.reference_number+': '+this.defaults.commercial_name || ''],
      cost: ['', [Validators.required]],
      total_quantity_val: [this.defaults.balance+' '+(this.defaults.delivered_unit || '')],
      purchase_amount: [this.defaults.purchased_amount || ''],
      delivered_quantity: [this.defaults.delivered_quantity || '', [Validators.required]],
