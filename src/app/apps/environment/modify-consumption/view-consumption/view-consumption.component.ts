...
export class ViewModifyConsumptionComponent implements OnInit {
  Form: FormGroup
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ViewModifyConsumptionComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.defaults) {
      ...
      this.Form.controls['add_meter'].setValue(this.defaults?.attributes.add_meter);
      ...
      if (this.defaults.attributes.disposal_date != null) {
  ...
  //   this._lightbox.open(this.evidences, index, { positionFromTop: 300, fitImageInViewPort: true });
  // }
