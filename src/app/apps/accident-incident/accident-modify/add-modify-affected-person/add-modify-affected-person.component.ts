...
export class AddModifyAffectedPersonComponentModify implements OnInit {
  ...
  private formBuilder: FormBuilder,
    ...
    public dialogRef: MatDialogRef<AddModifyAffectedPersonComponentModify>) { }
  ...
  ngOnInit(){
    ...
    this.Form = this.formBuilder.group({
      ...
      date_of_join:[this.defaults?.attributes?.date_of_join || '']
    });
