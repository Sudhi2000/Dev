...
@Component({
  selector: 'app-add-upstream-category',
  templateUrl: './add-upstream-category.component.html',
  styleUrls: ['./add-upstream-category.component.scss']
})
export class AddUpstreamCategoryComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    public dialogRef: MatDialogRef<AddUpstreamCategoryComponent>) { }
