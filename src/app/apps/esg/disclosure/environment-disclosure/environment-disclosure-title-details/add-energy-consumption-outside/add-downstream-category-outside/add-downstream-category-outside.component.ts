...
@Component({
  selector: 'app-add-downstream-category-outside',
  templateUrl: './add-downstream-category-outside.component.html',
  styleUrls: ['./add-downstream-category-outside.component.scss']
})
export class AddDownstreamCategoryOutsideComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    public dialogRef: MatDialogRef<AddDownstreamCategoryOutsideComponent>) { }
