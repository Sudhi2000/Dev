...
@Component({
  selector: 'app-add-disclosure-team-member',
  templateUrl: './add-disclosure-team-member.component.html',
  styleUrls: ['./add-disclosure-team-member.component.scss']
})
export class AddDisclosureTeamMemberComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    ...
    public dialogRef: MatDialogRef<AddDisclosureTeamMemberComponent>
  ) { }
  ...
  checkDuplication(selectedMember: any) {
    ...
    this.duplicateMember = this.defaults.some((member: any) => parseInt(member.userID) === selectedMember.id);
