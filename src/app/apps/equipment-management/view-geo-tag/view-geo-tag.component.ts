...
@Component({
  selector: 'app-view-geo-tag',
  templateUrl: './view-geo-tag.component.html',
  styleUrls: ['./view-geo-tag.component.scss'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS }
  ]
})
export class ViewGeoTagComponent implements OnInit {
  ...
  private formBuilder: FormBuilder,
    ...
    public dialogRef: MatDialogRef<ViewGeoTagComponent>,
  ...
  ngOnInit() {
    ...
    this.Form = this.formBuilder.group({
      id:[this.defaults.id],
      equipment: [this.defaults.attributes?.equipment?.data?.attributes.equipment_name || ''],
      manufacturer: [this.defaults.attributes?.manufacturer?.data?.attributes?.name || ''],
      price: [this.defaults.attributes.price || ''],
