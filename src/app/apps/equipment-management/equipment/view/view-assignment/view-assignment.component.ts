...
export class ViewAssignmentComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    ...
    public dialogRef: MatDialogRef<ViewAssignmentComponent>) { }
  ...
  default_details() {
    if (this.mode === 'update') {
      ...
      this.Form.controls['client_name'].setValue(this.defaults.attributes.client.data.attributes.client_name)
      this.Form.controls['assigned_operator'].setValue(this.defaults.attributes.assigned_operator.data.attributes.first_name+' '+this.defaults.attributes.assigned_operator.data.attributes.last_name)
